...
public class GameState {
  ...
  public static GameState forGame(Game game) {
    ...
    String current = currentPlayer == Player.PLAYER0 ? "X" : "O";

    Player winnerPlayer = game.getWinner();
    String winner;
    if (winnerPlayer != null) {
      winner = winnerPlayer == Player.PLAYER0 ? "X" : "O";
    } else {
      winner = null;
    }

    return new GameState(cells, current, winner);
  }
  ...
  /** toString() of GameState will return the string representing the GameState in JSON format. */
  @Override
  public String toString() {
    ...
    """
        .formatted(Arrays.toString(this.cells), this.currentPlayer, this.winner != null ? "(" + this.winner + ")" : "null");
  }
